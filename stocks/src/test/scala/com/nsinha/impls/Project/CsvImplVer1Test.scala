...
class CsvImplVer1Test extends FunSuite with  ShouldMatchers with Injectable with Loggable {
  ...
  test("test1") {
    val quoteImpl = new CsvQuoteScottradeProjectImpl(modelFilePath = "/Users/nishchaysinha/nsinhamisc/stocks/src/test/resources/modelforcsv.txt", csvFilePath = "/Users/nishchaysinha/nsinhamisc/stocks/src/test/resources/file_datestart05302016T16:00:00Zdateend.csv", classzz = GenCsvQuoteRowScottrade.getClass)
    ...
    val topFlowers = quoteImpl.writeTopFlowers(10)
