...
object OrderAnalysis {
  def apply(quoteFile: String, orderFile: String, byDateFile: String =
  "/Users/nishchaysinha/stocksdatadir/currentPerformance/currentHoldsByDate.json" , bySymbolFile: String =
  "/Users/nishchaysinha/stocksdatadir/currentPerformance/currentHoldsBySymbol.json",
