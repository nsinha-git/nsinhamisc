...
object OrderAnalysis {
  ...
  def run() = {
    val quoteFile = "/Users/nsinha/Downloads/Securities_to_Watch2017.04.26.15.24.17.csv"
    val orderFile = "/Users/nsinha/Downloads/CompletedOrders2017.04.26.15.23.26.csv"
