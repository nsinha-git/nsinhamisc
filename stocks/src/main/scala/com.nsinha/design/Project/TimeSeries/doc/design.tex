...
\begin{frame}{TimeSeries}
	\begin{itemize}
		\item Reads a file (Json) like a yearly data file.
		\item Reads an attribute to be taken as dependent axis
		\item Creates an implicit timeseries data for that axis.
	\end{itemize}
\end{frame}
